...
##        item["Author_link_test"] = titles.select('//*[@class="content contains-text-link"]/a/@href').extract()
        ...
        item["Price"] = ''.join(titles.select('//*[@class="price buy id-track-click id-track-impression"]/span[2]/text()').extract())
        ...
        item["Description"] = ''.join(titles.select('//*[@itemprop="description"]//text()').extract())
        ...
        #item["Reviews"] = ''.join(titles.select('//*[@class="featured-review clickable"]//text()').extract())
        item["Ratings_5"] = ''.join(titles.select('//*[@class="rating-bar-container five"]/span[3]/text()').extract())
        item["Ratings_4"] = ''.join(titles.select('//*[@class="rating-bar-container four"]/span[3]/text()').extract())
        item["Ratings_3"] = ''.join(titles.select('//*[@class="rating-bar-container three"]/span[3]/text()').extract())
        item["Ratings_2"] = ''.join(titles.select('//*[@class="rating-bar-container two"]/span[3]/text()').extract())
        item["Ratings_1"] = ''.join(titles.select('//*[@class="rating-bar-container one"]/span[3]/text()').extract())
        items.append(item)
      return items
